...
private:
  ...
  queue<InternetDatagram> datagrams_received_ {};

  struct living_dgram{
    vector<InternetDatagram> dgrams_ {};
    size_t time_ = 0;
  };

  struct living_ethernetaddr{
    EthernetAddress address_ {};
    size_t time_ = 0;
  };

  unordered_map<uint32_t,living_dgram> living_frames_ = {};

  unordered_map<uint32_t,living_ethernetaddr> ip_eth_map_ = {};
